 ...
 */
  ...
  $linkSearch   = sefRelToAbs( "index.php?option=com_marketplace&amp;page=search&amp;Itemid=".$Itemid);
  ...
  <table class="jooTopmenu" cellspacing="1" cellpadding="0">
    <tr>
       ...
       <?php
       echo "<td class='jooTopmenu' valign='center'>";
       ...
       echo "<td valign=\"center\">";
         echo "<div style='width:100%; height:100%; vertical-align: center;'>";
           echo "<a href='".$linkSearch."' style='display: block;'>";

             echo "<span>";
               echo "<img src=\"".$mosConfig_live_site."/components/com_marketplace/images/system/search.gif\" border=\"0\" align=\"top\" >";
             echo "</span>";
			 echo "&nbsp;&nbsp;&nbsp;";
